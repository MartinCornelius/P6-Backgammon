...
if not os.path.exists("logs"):
    os.mkdir("logs")
folder = f"logs/near-home-bearoff-sims{num_simulations}"
os.mkdir(folder)
...
for heuristic in heuristic_list:
    ...
    dice_pairs, average_winrates, highest_winrates, best_moves, average_borne_offs, average_hits, average_opponent_hits, highest_hits = every_dice_simulation(num_simulations, near_home_board, heuristic, heuristics.bear_off_first)
